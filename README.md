# Sapper with Tailwind CSS and Typescript

A plain repository containing the bare minimum to run Sapper with Tailwind CSS
...
##### Fix IDE errors with `svelte-preprocess`
